...
<script src="s.js"></script>
  ...
  <div class="main-container"> <div class="pd-ltr-20 xs-pd-20-10"> <div
  class="min-height-200px"> <div class="page-header"> <div class="row"> <div
  class="col-md-6 col-sm-12"> <div class="title"> <h4>Report</h4> </div>
			...
			<div class="pd-20 card-box mb-30">
					...
					<div class="btn-list">
								...
								<button type="button"  onclick="generatePDF()" class="btn" data-bgcolor="#bd081c" data-color="#ffffff"><i class="fa fa-file-pdf-o"></i>  PDF</button>
								<button type="button" onclick="createExcel()" class="btn" data-bgcolor="#00b489" data-color="#ffffff"><i class="fa fa-file-excel-o"></i> EXCEL</button>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>From To :</label>
                                    <input class="form-control datetimepicker" placeholder="" name="ft" type="text" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Date To :</label>
                                    <input class="form-control datetimepicker" placeholder="" name="dt" type="text" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
